...
const rule = require('./newline-after-var')
...
const FOR_IN_LOOP_WITH_VAR = 'for(var a in obj){\n break;\n}'
const FOR_OF_LOOP_WITH_LET = 'for(let a in obj){\n break;\n}'
const FOR_OF_LOOP_WITH_VAR = 'for(var a in obj){\n break;\n}'
