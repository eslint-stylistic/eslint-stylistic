...
export default createRule<MessageIds, RuleOptions>({
  ...
  create(context) {
    ...
    function isFirstBangInBangBangExpression(node: ASTNode) {
      ...
      const expr = node as Tree.UnaryExpression
    ...
    function verifyNonWordsHaveSpaces(
      node: Tree.UnaryExpression | Tree.UpdateExpression | Tree.NewExpression,
      firstToken: Token,
      secondToken: Token,
    ) {
     ...
     * @returns {void}
     */
    function checkForSpaces(node: Tree.UnaryExpression | Tree.UpdateExpression | Tree.NewExpression) {
