...
import type { ASTNode, ReportFixFunction, RuleListener, Tree } from '@shared/types'
import { AST_NODE_TYPES } from '@typescript-eslint/utils'
import { LINEBREAK_MATCHER, isClosingBracketToken, isColonToken } from '@typescript-eslint/utils/ast-utils'
import { getStaticPropertyName } from '../../utils/ast-utils'
import { createTSRule, getStringLength } from '../../utils'
  ...
  create(context, [_options]) {
    ...
    function isKeyValueProperty(property: Tree.ObjectLiteralElement): property is Tree.Property {
      return !(
        ...
        || ('kind' in property && property.kind !== 'init') || property.type !== AST_NODE_TYPES.Property) // Could be "ExperimentalSpreadProperty" or "SpreadElement"
      )
    }
    ...
    const baseRules: RuleListener = alignmentOptions // Verify vertical alignment
      ? {
