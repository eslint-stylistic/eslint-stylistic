...
import type { ArrayBracketNewlineRuleOptions } from '../../eslint-plugin/rules/array-bracket-newline/types'
import type { ArrayBracketSpacingRuleOptions } from '../../eslint-plugin/rules/array-bracket-spacing/types'
import type { ArrayElementNewlineRuleOptions } from '../../eslint-plugin/rules/array-element-newline/types'
import type { ArrowParensRuleOptions } from '../../eslint-plugin/rules/arrow-parens/types'
import type { ArrowSpacingRuleOptions } from '../../eslint-plugin/rules/arrow-spacing/types'
...
import type { CommaStyleRuleOptions } from '../../eslint-plugin/rules/comma-style/types'
import type { ComputedPropertySpacingRuleOptions } from '../../eslint-plugin/rules/computed-property-spacing/types'
...
import type { JsxQuotesRuleOptions } from '../../eslint-plugin/rules/jsx-quotes/types'
...
import type { LineCommentPositionRuleOptions } from '../../eslint-plugin/rules/line-comment-position/types'
import type { LinebreakStyleRuleOptions } from '../../eslint-plugin/rules/linebreak-style/types'
...
import type { MaxLenRuleOptions } from '../../eslint-plugin/rules/max-len/types'
import type { MaxStatementsPerLineRuleOptions } from '../../eslint-plugin/rules/max-statements-per-line/types'
import type { MultilineCommentStyleRuleOptions } from '../../eslint-plugin/rules/multiline-comment-style/types'
import type { MultilineTernaryRuleOptions } from '../../eslint-plugin/rules/multiline-ternary/types'
import type { NewParensRuleOptions } from '../../eslint-plugin/rules/new-parens/types'
import type { NewlinePerChainedCallRuleOptions } from '../../eslint-plugin/rules/newline-per-chained-call/types'
import type { NoConfusingArrowRuleOptions } from '../../eslint-plugin/rules/no-confusing-arrow/types'
...
import type { NoFloatingDecimalRuleOptions } from '../../eslint-plugin/rules/no-floating-decimal/types'
import type { NoMixedOperatorsRuleOptions } from '../../eslint-plugin/rules/no-mixed-operators/types'
import type { NoMixedSpacesAndTabsRuleOptions } from '../../eslint-plugin/rules/no-mixed-spaces-and-tabs/types'
import type { NoMultiSpacesRuleOptions } from '../../eslint-plugin/rules/no-multi-spaces/types'
import type { NoMultipleEmptyLinesRuleOptions } from '../../eslint-plugin/rules/no-multiple-empty-lines/types'
import type { NoTabsRuleOptions } from '../../eslint-plugin/rules/no-tabs/types'
import type { NoTrailingSpacesRuleOptions } from '../../eslint-plugin/rules/no-trailing-spaces/types'
import type { NoWhitespaceBeforePropertyRuleOptions } from '../../eslint-plugin/rules/no-whitespace-before-property/types'
...
import type { RestSpreadSpacingRuleOptions } from '../../eslint-plugin/rules/rest-spread-spacing/types'
import type { SemiSpacingRuleOptions } from '../../eslint-plugin/rules/semi-spacing/types'
import type { SemiStyleRuleOptions } from '../../eslint-plugin/rules/semi-style/types'
...
import type { SpaceInParensRuleOptions } from '../../eslint-plugin/rules/space-in-parens/types'
import type { SpaceInfixOpsRuleOptions } from '../../eslint-plugin/rules/space-infix-ops/types'
import type { SpaceUnaryOpsRuleOptions } from '../../eslint-plugin/rules/space-unary-ops/types'
import type { SpacedCommentRuleOptions } from '../../eslint-plugin/rules/spaced-comment/types'
import type { SwitchColonSpacingRuleOptions } from '../../eslint-plugin/rules/switch-colon-spacing/types'
import type { TemplateCurlySpacingRuleOptions } from '../../eslint-plugin/rules/template-curly-spacing/types'
import type { TemplateTagSpacingRuleOptions } from '../../eslint-plugin/rules/template-tag-spacing/types'
import type { WrapIifeRuleOptions } from '../../eslint-plugin/rules/wrap-iife/types'
import type { WrapRegexRuleOptions } from '../../eslint-plugin/rules/wrap-regex/types'
import type { YieldStarSpacingRuleOptions } from '../../eslint-plugin/rules/yield-star-spacing/types'
