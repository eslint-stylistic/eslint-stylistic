...
run<RuleOptions, MessageIds>({
  ...
  valid: [
    ...
    { code: '({ [x]: 0 });', parserOptions: { ecmaVersion: 6 } },
    { code: '({ x });', parserOptions: { ecmaVersion: 6 } },
    { code: '({ a: 0, b(){} })', options: ['as-needed'], parserOptions: { ecmaVersion: 6 } },
    { code: '({ a: 0, [x]: 1 })', options: ['as-needed'], parserOptions: { ecmaVersion: 6 } },
    { code: '({ a: 0, x })', options: ['as-needed'], parserOptions: { ecmaVersion: 6 } },
    { code: '({ \'@\': 0, [x]: 1 })', options: ['as-needed'], parserOptions: { ecmaVersion: 6 } },
    { code: '({ \'@\': 0, x })', options: ['as-needed'], parserOptions: { ecmaVersion: 6 } },
    ...
    { code: '({ a: 0, b: 0 })', options: ['consistent'] },
    { code: '({ \'a\': 1, [x]: 0 });', options: ['consistent'], parserOptions: { ecmaVersion: 6 } },
    { code: '({ \'a\': 1, x });', options: ['consistent'], parserOptions: { ecmaVersion: 6 } },
    ...
    { code: '({ \'@\': 1, [x]: 0 });', options: ['consistent-as-needed'], parserOptions: { ecmaVersion: 6 } },
    { code: '({ \'@\': 1, x });', options: ['consistent-as-needed'], parserOptions: { ecmaVersion: 6 } },
    { code: '({ a: 1, [x]: 0 });', options: ['consistent-as-needed'], parserOptions: { ecmaVersion: 6 } },
    { code: '({ a: 1, x });', options: ['consistent-as-needed'], parserOptions: { ecmaVersion: 6 } },
