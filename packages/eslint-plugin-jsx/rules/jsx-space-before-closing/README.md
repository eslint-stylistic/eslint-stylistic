# Enforce spacing before closing bracket in JSX (`@stylistic/jsx/jsx-space-before-closing`)

❌ This rule is deprecated. It was replaced by [`@stylistic/jsx/jsx-tag-spacing`](jsx-tag-spacing.md).
